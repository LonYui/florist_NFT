...
export default {
  ...
  computed:{
    verify(){
      let str_to_md5 = `11111222223333344444555556666677|${this.mid}|${this.txid}|${this.amount}|11111222223333344444555556666688`
    ...
    return_url(){
      return `${window.location.origin}/tabs/tab3?member_id=${this.member_id}`
    }
  },
  async mounted(){
    const _this = this
